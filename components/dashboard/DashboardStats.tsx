...
export default function DashboardStats({
  ...
  const completionColour = avgCompletion >= 50 ? 'text-price' : 'text-amber-400'
  const completionBorder = avgCompletion >= 50 ? 'border-l-2 border-l-price' : 'border-l-2 border-l-amber-400'
