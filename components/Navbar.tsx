        ...
        {user ? (
          <>
            ...
            <div className="flex items-center gap-1">
              ...
              <Link href="/wanted"               className="px-3 py-1.5 text-sm text-secondary hover:text-accent hover:bg-elevated rounded-lg transition-all">Wanted</Link>
              <Link href="/lists"                className="px-3 py-1.5 text-sm text-secondary hover:text-accent hover:bg-elevated rounded-lg transition-all">Lists</Link>
