-- =====================================================
-- POKEMON TCG COLLECTION - DATABASE SCHEMA (FIXED)
-- =====================================================
...
-- Profiles table (extends Supabase auth.users) - NO FOREIGN KEYS YET
...
-- User collections table - NO FOREIGN KEYS YET
...
-- Friendships table - NO FOREIGN KEYS YET
...
-- Trades table - NO FOREIGN KEYS YET
CREATE TABLE trades (
  id UUID DEFAULT uuid_generate_v4() PRIMARY KEY,
...
-- Trade items table - NO FOREIGN KEYS YET
...
-- Wishlists table - NO FOREIGN KEYS YET
...
-- User achievements table - NO FOREIGN KEYS YET
...
-- Collection stats table - NO FOREIGN KEYS YET
...
-- Add favorite_set_id column to profiles
...
-- Add foreign keys for user_collections
ALTER TABLE user_collections ADD CONSTRAINT user_collections_user_id_fkey
  FOREIGN KEY (user_id) REFERENCES profiles(id) ON DELETE CASCADE;
ALTER TABLE user_collections ADD CONSTRAINT user_collections_card_id_fkey
...
ALTER TABLE trades ADD CONSTRAINT trades_initiator_id_fkey
  FOREIGN KEY (initiator_id) REFERENCES profiles(id) ON DELETE CASCADE;
ALTER TABLE trades ADD CONSTRAINT trades_recipient_id_fkey
  FOREIGN KEY (recipient_id) REFERENCES profiles(id) ON DELETE CASCADE;

-- Add foreign keys for trade_items
ALTER TABLE trade_items ADD CONSTRAINT trade_items_trade_id_fkey
  FOREIGN KEY (trade_id) REFERENCES trades(id) ON DELETE CASCADE;
ALTER TABLE trade_items ADD CONSTRAINT trade_items_user_id_fkey
  FOREIGN KEY (user_id) REFERENCES profiles(id) ON DELETE CASCADE;
ALTER TABLE trade_items ADD CONSTRAINT trade_items_card_id_fkey
  FOREIGN KEY (card_id) REFERENCES cards(id) ON DELETE CASCADE;

-- Add foreign keys for wishlists
ALTER TABLE wishlists ADD CONSTRAINT wishlists_user_id_fkey
  FOREIGN KEY (user_id) REFERENCES profiles(id) ON DELETE CASCADE;
ALTER TABLE wishlists ADD CONSTRAINT wishlists_card_id_fkey
  FOREIGN KEY (card_id) REFERENCES cards(id) ON DELETE CASCADE;
...
-- Add foreign keys for collection_stats
ALTER TABLE collection_stats ADD CONSTRAINT collection_stats_user_id_fkey
  FOREIGN KEY (user_id) REFERENCES profiles(id) ON DELETE CASCADE;
ALTER TABLE collection_stats ADD CONSTRAINT collection_stats_set_id_fkey
...
-- =====================================================
-- SETUP COMPLETE - SCHEMA FIXED!
-- =====================================================

/*
INSTRUCTIONS FOR RUNNING THIS FIXED SCHEMA:

1. Open your Supabase project dashboard
2. Go to the SQL Editor
3. Copy and paste this entire schema-fixed.sql file
4. Click "Run" to execute

✅ FIXED: All foreign key dependency issues resolved
...
- profiles, sets, cards, user_collections, friendships, trades, 
  trade_items, wishlists, user_achievements, collection_stats
